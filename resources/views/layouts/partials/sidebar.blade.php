...
<div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href=" {{ route('dashboard') }} ">
        <img src="{{ asset ('.') }}/assets/img/nty.png" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-2 font-weight-bold" style="font-size: 17px;">Uji Kompetensi</span>
    </a>
</div>
    ...
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('dashboard') ? 'active' : '' }}"
               ...
               style="{{ request()->routeIs('dashboard') ? 'color: orange;' : '' }}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->routeIs('pegawai.index') ? 'active' : '' }}"
               ...
               style="{{ request()->routeIs('pegawai.index') ? 'color: orange;' : '' }}">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
...
<div class="sidenav-footer mx-3 ">
    ...
    <a class="btn btn-primary btn-sm mb-0 w-100"
        href="{{ route('logout') }}" type="button">Sign Out</a>
</div>
</aside>
